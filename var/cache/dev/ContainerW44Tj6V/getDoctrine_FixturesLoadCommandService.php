...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Doctrine/DataFixtures/TagFixtures.php';
        ...
        $b = new \App\Rating\RatingHandler();

        $a->addFixtures([['fixture' => new \App\Doctrine\DataFixtures\TagFixtures(), 'groups' => []], ['fixture' => new \App\Doctrine\DataFixtures\UserFixtures(), 'groups' => []], ['fixture' => new \App\Doctrine\DataFixtures\VideoGameFixtures(\App\Faker\FrenchGeneratorFactory::create(), $b, $b), 'groups' => []]]);
