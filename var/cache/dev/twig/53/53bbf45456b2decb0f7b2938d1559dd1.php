...
class __TwigTemplate_8d5d16aa9e40b58288b541f1a944047b extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 3
        echo $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("Rating", ["rating" => twig_get_attribute($this->env, $this->source, (isset($context["review"]) || array_key_exists("review", $context) ? $context["review"] : (function () { throw new RuntimeError('Variable "review" does not exist.', 3, $this->source); })()), "note", [], "any", false, false, false, 3), "label" => "Note"]);
        echo "
...
\t<div class=\"d-flex gap-3\">
\t\t{{ component('Rating', { rating: (review.note), label: 'Note' }) }}
\t\t<div class=\"d-flex flex-column gap-2 w-100 justify-content-start\">
...
", "components/Review.html.twig", "/Users/diabiraaly/Desktop/Bureau - MacBook Air de DIABIRA/Openclassrooms/OC14/Exercice Mettez en place des tests dans votre code/templates/components/Review.html.twig");
    }
}
