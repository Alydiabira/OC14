...
class __TwigTemplate_138063916db0b44fe652f06111adae32 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 7
        echo $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("Sorting", ["list" => ($context["list"] ?? null)]);
        echo "
\t\t\t\t";
        // line 8
        echo $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("Info", ["info" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["list"] ?? null), "pagination", [], "any", false, false, false, 8), "getInfo", [], "method", false, false, false, 8)]);
        echo "
...
\t\t\t\t";
        // line 14
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["list"] ?? null), "pagination", [], "any", false, false, false, 14)) > 1)) {
            // line 15
            echo "\t\t\t\t\t";
            echo $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("Pagination", ["pagination" => twig_get_attribute($this->env, $this->source, ($context["list"] ?? null), "pagination", [], "any", false, false, false, 15)]);
            echo "
\t\t\t\t";
        }
        // line 17
...
\t\t\t\t";
        // line 19
        echo $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("Filter", ["list" => ($context["list"] ?? null)]);
        echo "
\t\t\t</div>
\t\t</div>
\t</div>
