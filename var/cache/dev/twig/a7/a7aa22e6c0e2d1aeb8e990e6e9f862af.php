...
";
    ...
    {
        return array (  96 => 12,  91 => 10,  88 => 9,  82 => 7,  80 => 6,  76 => 4,  63 => 3,  40 => 1,);
    }
...
\t{% if error %}
\t\t<div>{{ error.messageKey|trans(error.messageData, \x27security\x27) }}</div>
\t{% endif %}

\t<form method=\"post\" action=\"{{ path(\x27auth_login\x27) }}\">
\t\t<label>Email</label>
