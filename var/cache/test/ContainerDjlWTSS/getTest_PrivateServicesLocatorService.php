...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Doctrine\\DataFixtures\\TagFixtures' => ['privates', 'App\\Doctrine\\DataFixtures\\TagFixtures', 'getTagFixturesService', true],
            'App\\Doctrine\\DataFixtures\\UserFixtures' => ['privates', 'App\\Doctrine\\DataFixtures\\UserFixtures', 'getUserFixturesService', true],
            'App\\Doctrine\\DataFixtures\\VideoGameFixtures' => ['privates', 'App\\Doctrine\\DataFixtures\\VideoGameFixtures', 'getVideoGameFixturesService', true],
            ...
            'App\\List\\ListFactory' => ['privates', 'App\\List\\ListFactory', 'getListFactoryService', true],
            'App\\List\\VideoGameList\\PaginationValueResolver' => ['privates', 'App\\List\\VideoGameList\\PaginationValueResolver', 'getPaginationValueResolver2Service', true],
            'App\\Rating\\RatingHandler' => ['privates', 'App\\Rating\\RatingHandler', 'getRatingHandlerService', true],
            'App\\Security\\Voter\\VideoGameVoter' => ['privates', 'App\\Security\\Voter\\VideoGameVoter', 'getVideoGameVoter2Service', true],
            'App\\Twig\\Components\\Alert' => [false, 'App\\Twig\\Components\\Alert', 'getAlertService', true],
            'App\\Twig\\Components\\Card' => [false, 'App\\Twig\\Components\\Card', 'getCardService', true],
            'App\\Twig\\Components\\Filter' => [false, 'App\\Twig\\Components\\Filter', 'getFilterService', true],
            'App\\Twig\\Components\\Info' => [false, 'App\\Twig\\Components\\Info', 'getInfoService', true],
            'App\\Twig\\Components\\NavBar' => [false, 'App\\Twig\\Components\\NavBar', 'getNavBarService', true],
            'App\\Twig\\Components\\Pagination' => [false, 'App\\Twig\\Components\\Pagination', 'getPagination2Service', true],
            'App\\Twig\\Components\\Progress' => [false, 'App\\Twig\\Components\\Progress', 'getProgressService', true],
            'App\\Twig\\Components\\Rating' => [false, 'App\\Twig\\Components\\Rating', 'getRatingService', true],
            'App\\Twig\\Components\\Review' => [false, 'App\\Twig\\Components\\Review', 'getReviewService', true],
            'App\\Twig\\Components\\Sorting' => [false, 'App\\Twig\\Components\\Sorting', 'getSortingService', true],
            'App\\Twig\\Components\\Tabs' => [false, 'App\\Twig\\Components\\Tabs', 'getTabsService', true],
            'Faker\\Generator' => ['privates', 'Faker\\Generator', 'getGeneratorService', true],
            ...
            'security.user.provider.concrete.user_provider' => ['privates', 'security.user.provider.concrete.user_provider', 'getSecurity_User_Provider_Concrete_UserProviderService', true],
            ...
            'sass.builder' => ['privates', 'sass.builder', 'getSass_BuilderService', true],
            'sass.command.build' => ['privates', 'sass.command.build', 'getSass_Command_BuildService', true],
            'sass.css_asset_compiler' => ['privates', 'sass.css_asset_compiler', 'getSass_CssAssetCompilerService', true],
            'sass.public_asset_path_resolver' => ['privates', 'sass.public_asset_path_resolver', 'getSass_PublicAssetPathResolverService', false],
            'sass.listener.pre_assets_compile' => ['privates', 'sass.listener.pre_assets_compile', 'getSass_Listener_PreAssetsCompileService', true],
            ...
            'sass.public_asset_path_resolver.inner' => ['privates', 'sass.public_asset_path_resolver.inner', 'getSass_PublicAssetPathResolver_InnerService', false],
            ...
            'App\\Rating\\CalculateAverageRating' => ['privates', 'App\\Rating\\RatingHandler', 'getRatingHandlerService', true],
            'App\\Rating\\CountRatingsPerValue' => ['privates', 'App\\Rating\\RatingHandler', 'getRatingHandlerService', true],
            ...
            'security.user_providers' => ['privates', 'security.user.provider.concrete.user_provider', 'getSecurity_User_Provider_Concrete_UserProviderService', true],
            'Symfony\\Component\\Security\\Core\\User\\UserProviderInterface' => ['privates', 'security.user.provider.concrete.user_provider', 'getSecurity_User_Provider_Concrete_UserProviderService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.nqA6t1n', 'get_ServiceLocator_NqA6t1nService', true],
            ...
            'asset_mapper.public_assets_path_resolver' => ['privates', 'sass.public_asset_path_resolver', 'getSass_PublicAssetPathResolverService', false],
            ...
            'App\\Doctrine\\DataFixtures\\TagFixtures' => '?',
            'App\\Doctrine\\DataFixtures\\UserFixtures' => '?',
            'App\\Doctrine\\DataFixtures\\VideoGameFixtures' => '?',
            'App\\Doctrine\\EntityListener\\UserListener' => '?',
            'App\\Doctrine\\Repository\\VideoGameRepository' => '?',
            'App\\Form\\FilterType' => '?',
            'App\\Form\\RegisterType' => '?',
            'App\\Form\\ReviewType' => '?',
            'App\\List\\ListFactory' => '?',
            'App\\List\\VideoGameList\\PaginationValueResolver' => '?',
            'App\\Rating\\RatingHandler' => '?',
            'App\\Security\\Voter\\VideoGameVoter' => '?',
            'App\\Twig\\Components\\Alert' => '?',
            'App\\Twig\\Components\\Card' => '?',
            'App\\Twig\\Components\\Filter' => '?',
            'App\\Twig\\Components\\Info' => '?',
            'App\\Twig\\Components\\NavBar' => '?',
            'App\\Twig\\Components\\Pagination' => '?',
            'App\\Twig\\Components\\Progress' => '?',
            'App\\Twig\\Components\\Rating' => '?',
            'App\\Twig\\Components\\Review' => '?',
            'App\\Twig\\Components\\Sorting' => '?',
            'App\\Twig\\Components\\Tabs' => '?',
            'Faker\\Generator' => '?',
            ...
            'sass.builder' => '?',
            'sass.command.build' => '?',
            'sass.css_asset_compiler' => '?',
            'sass.public_asset_path_resolver' => '?',
            'sass.listener.pre_assets_compile' => '?',
            ...
            'sass.public_asset_path_resolver.inner' => '?',
            ...
            'App\\Rating\\CalculateAverageRating' => '?',
            'App\\Rating\\CountRatingsPerValue' => '?',
