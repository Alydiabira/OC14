...
class App_KernelTestContainer extends Container
{
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $container->services['doctrine.dbal.default_connection'] = $instance = ($container->privates['doctrine.dbal.connection_factory'] ?? self::getDoctrine_Dbal_ConnectionFactoryService($container))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'use_savepoints' => true, 'dbname_suffix' => '_test', 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], ($container->privates['doctrine.dbal.default_connection.configuration'] ?? self::getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)), $a, []);
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost50b9cb7', static fn () => \EntityManagerGhost50b9cb7::createLazyGhost(static fn ($proxy) => self::getDoctrine_Orm_DefaultEntityManagerService($container, $proxy)));
        }
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriverService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Model/Entity')], true)), 'App\\Model\\Entity');
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['argument_resolver.request_payload'] = $container->createProxy('RequestPayloadValueResolverGhost1c3ee52', static fn () => \RequestPayloadValueResolverGhost1c3ee52::createLazyGhost(static fn ($proxy) => self::getArgumentResolver_RequestPayloadService($container, $proxy)));
        }
    ...
    protected static function getAssetMapper_CachedMappedAssetFactory_InnerService($container)
    {
        ...
        return $container->privates['asset_mapper.cached_mapped_asset_factory.inner'] = new \Symfony\Component\AssetMapper\Factory\MappedAssetFactory(($container->privates['sass.public_asset_path_resolver'] ?? self::getSass_PublicAssetPathResolverService($container)), $a, (\dirname(__DIR__, 4).'/assets/vendor'));
    }
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('Z6h-ZmAT1U', 0, $container->getParameter('container.build_id'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q88wJcwov3', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P-LCGiW2tK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FO-RbCnOmq', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getControllerResolverService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\VideoGameController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Model/Entity')], true);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setEntityNamespaces(['App' => 'App\\Model\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity']);
     ...
     */
    protected static function getSass_PublicAssetPathResolverService($container)
    {
        return $container->privates['sass.public_asset_path_resolver'] = new \Symfonycasts\SassBundle\AssetMapper\SassPublicPathAssetPathResolver(($container->privates['sass.public_asset_path_resolver.inner'] ??= new \Symfony\Component\AssetMapper\Path\PublicAssetsPathResolver('/assets/')));
    }

    /*
     * Gets the private 'sass.public_asset_path_resolver.inner' shared service.
     *
     * @return \Symfony\Component\AssetMapper\Path\PublicAssetsPathResolver
     */
    protected static function getSass_PublicAssetPathResolver_InnerService($container)
    {
        return $container->privates['sass.public_asset_path_resolver.inner'] = new \Symfony\Component\AssetMapper\Path\PublicAssetsPathResolver('/assets/');
    }
    ...
    {
        return $container->privates['serializer.normalizer.problem'] = new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false, translator: ($container->services['translator'] ?? self::getTranslatorService($container)));
    }
    ...
    {
        $container->privates['twig'] = $instance = new \Twig\Environment(($container->privates['twig.loader.native_filesystem'] ?? self::getTwig_Loader_NativeFilesystemService($container)), ['strict_variables' => true, 'autoescape' => 'name', 'cache' => ($container->targetDir.''.'/twig'), 'charset' => 'UTF-8', 'debug' => false]);
        ...
        $instance->addExtension(($container->privates['ux.twig_component.twig.component_extension'] ?? self::getUx_TwigComponent_Twig_ComponentExtensionService($container)));
    ...
    {
        return $container->privates['ux.twig_component.twig.component_extension'] = new \Symfony\UX\TwigComponent\Twig\ComponentExtension((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        $container->privates['vich_uploader.metadata_factory'] = $instance = new \Metadata\MetadataFactory(($container->privates['vich_uploader.metadata_driver.chain'] ?? self::getVichUploader_MetadataDriver_ChainService($container)), 'Metadata\\ClassHierarchyMetadata', false);
