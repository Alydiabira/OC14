...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriver_InnerService($container)
    {
        ...
        $instance->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Model/Entity')], true)), 'App\\Model\\Entity');
    ...
    protected static function getAssetMapper_CachedMappedAssetFactory_InnerService($container)
    {
        ...
        $instance = new \Symfony\Component\AssetMapper\Factory\MappedAssetFactory(($container->privates['sass.public_asset_path_resolver'] ?? self::getSass_PublicAssetPathResolverService($container)), $a, (\dirname(__DIR__, 4).'/assets/vendor'));
    ...
    {
        return $container->privates['cache.ux.twig_component.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kKU4NYOBu3', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
